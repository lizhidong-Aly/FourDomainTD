...
function StartBuildingHelper( params )
{
    if (params !== undefined)
    {
        ...
        // Building Ghost
        modelParticle = Particles.CreateParticle("particles/custom_effect/element_summon_effect.vpcf", ParticleAttachment_t.PATTACH_CUSTOMORIGIN, 0);
        Particles.SetParticleControlEnt(modelParticle, 3, entindex, ParticleAttachment_t.PATTACH_ABSORIGIN_FOLLOW, "follow_origin", Entities.GetAbsOrigin(entindex), true)
    ...
    {   
        ...
        if ( GamePos !== null ) 
        {
            ...
            modelPos[2]+=modelOffset-48
            Particles.SetParticleControl(modelParticle, 0, modelPos)
            Particles.SetParticleControl(modelParticle, 5, modelPos)
            //Particles.SetParticleControl(modelParticle, 1, modelPos)
